...
class GenDataset(Dataset):
    def __init__(self,
        ...
        self.img_array = input_np_array
        self.class_ids = class_ids
        self.min_class_id = min_class_id
        self.repeats = repeats
        self.num_images = len(self.img_array)
    ...
    def set_subset(self, index_ls):
        self.img_array = self.img_array[index_ls]
        self.class_ids = self.class_ids[index_ls]
        self.num_images = len(self.img_array)
        self._length = self.num_images
        if set == "train":
    ...
    def __getitem__(self, i):
        example = {}
        image = Image.fromarray(self.img_array[i % self.num_images])
        class_id = self.class_ids[i % self.num_images]
