...
from utils.toolkit import split_images_labels, split_images_labels2
import os
...
class TinyImageNet200(iData):   # 200*500=10w, 5 tasks, each task=40*500=2w
    ...
    def download_data(self):
        # assert 0, "You should specify the folder of your dataset"
        tinyimagenet_data_dir = "/mnt/share/yinjunhui/data"
        train_dir = "{}/tiny-imagenet-200/train/".format(tinyimagenet_data_dir)
        test_dir = "{}/tiny-imagenet-200/val/".format(tinyimagenet_data_dir)
        # print()
        ...
        self.train_data, self.train_targets = split_images_labels2(train_dset.imgs)
        self.test_data, self.test_targets = split_images_labels2(test_dset.imgs)
